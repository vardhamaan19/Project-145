...
label_ID = canvas.create_text(150, 90, font=('Times', '24', 'bold italic'), text="ID")
label_name_tag = canvas.create_text(40, 165, font=('Times', '16', 'bold'), text="Name :")
label_Pin no_tag = canvas.create_text(40, 205, font=('Times', '16', 'bold'), text="Pin no :")
label_Adddress_tag = canvas.create_text(50, 250, font=('Times', '16', 'bold'), text="Address :")
label_Authorisation to drive the following vehicles_tag = canvas.create_text(50, 250, font=('Times', '16', 'bold'), text="Authorisation to drive the following vehicles :")
